...
struct KeychainItem {
    ...
    static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try KeychainItem(service: "com.braincloud.bcchat", account: "userIdentifier").readItem()
    ...
    static func deleteUserIdentifierFromKeychain() {
        do {
            try KeychainItem(service: "com.braincloud.bcchat", account: "userIdentifier").deleteItem()
        } catch {
